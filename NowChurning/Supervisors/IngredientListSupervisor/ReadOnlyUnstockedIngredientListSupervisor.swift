//
//  ReadOnlyUnstockedIngredientListSupervisor.swift
//  NowChurning
//
...
protocol ReadOnlyIngredientListSupervisorParent: ParentSupervisor, IngredientListAppNavDelegate {}

class ReadOnlyUnstockedIngredientListSupervisor: NSObject, Supervisor {
    ...
    private let listStore: UnstockedIngredientListCoreDataStore
    ...
    init?(
        ...
        guard let listStore = UnstockedIngredientListCoreDataStore(
            sink: application,
